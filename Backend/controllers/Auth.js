...
exports.signup=async (req,res)=>{
    try{
        const {firstname,lastname,email,password,confirmpassword,accounttype,otp,secretkey}=req.body;
...
exports.forgotpasswordtoken=async (req,res)=>{
    ...
    const link=`https://career-sync-nita.vercel.app/updatepassword/${token}`
